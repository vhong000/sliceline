...
router.register(r'customer/review', ReviewViewSet, base_name='review')
...
router.register(r'delivery/review',DeliveryReviewViewSet , base_name='review')
...
urlpatterns = [
    ...
    # url(r'^manager/order/(?P<emp_id>\d+)/$', deliverOrder),  # get all order with current status 0 and store #
    url(r'^delivery/order/(?P<emp_id>\d+)/$',deliverOrder),
]
